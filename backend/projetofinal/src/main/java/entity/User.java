...
@NamedQuery(name = "User.findUserContainingStr", query = "SELECT u FROM User u WHERE LOWER(u.firstName) LIKE LOWER(:str) OR LOWER(u.lastName) LIKE LOWER(:str) OR LOWER(u.nickname) LIKE LOWER(:str)  AND u.validated = true")
