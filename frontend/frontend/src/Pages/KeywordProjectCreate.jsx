  ...
  return (
    <>
      ...
      {keywords && keywords.length > 0 ? (
        <div
          className="row p-2  rounded-2 mt-3 mb-3 overflow-auto d-flex justify-content-between mx-auto"
          style={{ maxHeight: "200px" }}
        >
          {keywords.map((item, position) => (
            <>
              <div className=" col-lg-3  text-white bg-black rounded-3 p-2 m-1 d-flex justify-content-around">
                <h6>{item.title} </h6>
                <div className="">
                  <OverlayTrigger
                    placement="top"
...
export default KeywordProjectCreate;
